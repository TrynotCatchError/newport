      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `Technology`,
              subtitle: `All frame work and libary i used`,
              description: `Nextjs, Reactjs, Redux, Javascript, Typescript, Html, Css, Node js, Express, Mongodb, Aws Service, CloudFlare `,
            }}
          />
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="/images/brand/express-109.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/brand/cloudflare-1.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
